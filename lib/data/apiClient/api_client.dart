...
//post request for creating a influencer profile
  ...
  Future <List<Influencer>> getInfluencers(int pageNumber, int limit,var token) async {
    Response response;
    try {
      response = await get(
  ...
  //List of jobs of an influencer
  Future <Response> getInfluencerJobs(int pageNumber, int limit,var token) async {
    Response response;
    try {
      response = await get(
        'creators/me/jobs',
